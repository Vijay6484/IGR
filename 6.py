...
def main():
    """Main function - Years 2015 to 2006 (shared scraper_output)"""
    years_to_scrape = [str(year) for year in range(2015, 2005, -1)]
    print(f"[6.py] Scraping years: {years_to_scrape[0]} to {years_to_scrape[-1]}")
